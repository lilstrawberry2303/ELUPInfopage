...
export function RoleSwitcher() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-2 px-3 py-2 md:gap-4 md:px-6 md:py-3">
        {/* Logo + app name */}
        <div className="flex items-center gap-2 md:gap-3">
          <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg shadow-sm overflow-hidden md:h-10 md:w-10 ${state.settings.logoUrl ? "bg-white border border-border/40" : "bg-primary text-primary-foreground"}`}>
